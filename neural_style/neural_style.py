...
def train(args):
    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            if args.checkpoint_model_dir is not None and (batch_id + 1) % args.checkpoint_interval == 0:
                ...
                ckpt_model_filename = str(train_id)+"ckpt_epoch_" + str(e) + "_batch_id_" + str(batch_id + 1) + ".pth"
    ...
    # save model
    transformer.eval().cpu()
    save_model_filename = str(train_id)+"epoch_" + str(args.epochs) + "_" + str(time.ctime()).replace(' ', '_') + "_" + str(
